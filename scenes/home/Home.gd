...
func _show_welcome() -> void:
	...
	body_label.text = Loc.t_gendered("home_welcome_body", {"player_name": GameData.profile.player_name})
...
func _show_menu() -> void:
	...
	greeting_label.text = Loc.t_gendered("menu_greeting", {"player_name": GameData.profile.player_name})
